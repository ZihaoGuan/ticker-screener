...
from src.three_weeks_tight_screen import run_three_weeks_tight_screen
from src.three_weeks_tight_watchlist_builder import build_three_weeks_tight_watchlist
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run three weeks tight screener.")
...
def main() -> int:
    ...
    result = run_three_weeks_tight_screen(config, tickers, as_of_date=as_of_date)
    watchlist = build_three_weeks_tight_watchlist(result.hits)
    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="three_weeks_tight", date_label=date_label)
