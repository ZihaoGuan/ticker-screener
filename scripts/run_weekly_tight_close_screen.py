...
from src.weekly_tight_close_screen import run_weekly_tight_close_screen
from src.weekly_tight_close_watchlist_builder import build_weekly_tight_close_watchlist


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the weekly tight close screener.")
...
def main() -> int:
    ...
    result = run_weekly_tight_close_screen(config, tickers, as_of_date=as_of_date)
    watchlist = build_weekly_tight_close_watchlist(result.hits)
    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="weekly_tight_close", date_label=date_label)
