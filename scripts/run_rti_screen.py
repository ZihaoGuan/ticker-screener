...
from src.rti_screen import run_rti_screen
from src.rti_watchlist_builder import build_rti_watchlist
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the RTI signal screen.")
...
def main() -> int:
    ...
    result = run_rti_screen(config, universe, as_of_date=as_of_date)
    watchlist = build_rti_watchlist(result.hits)

    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="rti", date_label=date_label)
