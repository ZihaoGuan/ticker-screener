...
from src.fearzone_zeiierman_screen import run_fearzone_zeiierman_screen
from src.fearzone_zeiierman_watchlist_builder import build_fearzone_zeiierman_watchlist
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the Zeiierman Fearzone screener.")
...
def main() -> int:
    ...
    result = run_fearzone_zeiierman_screen(config, tickers, as_of_date=as_of_date)
    watchlist = build_fearzone_zeiierman_watchlist(result.hits)

    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="fearzone_zeiierman", date_label=date_label)
