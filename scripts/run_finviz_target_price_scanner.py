...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run live Finviz target-price upside scanner.")
    ...
    parser.add_argument(
        ...
        help="Optional date used when loading the active DB universe fallback.",
    )
...
def main() -> int:
    ...
    result = run_finviz_target_price_scanner(
        limit=args.limit,
        tickers=requested_tickers,
        minimum_upside_ratio=TARGET_PRICE_UPSIDE_RATIO,
