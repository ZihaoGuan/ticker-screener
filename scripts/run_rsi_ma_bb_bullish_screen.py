...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the bullish RSI MA/BB signal screen.")
...
def main() -> int:
    ...
    result = run_rsi_ma_bb_screen(config, universe, direction="bullish", as_of_date=as_of_date)
    watchlist = build_rsi_ma_bb_watchlist(result.hits)

    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="rsi_ma_bb_bullish", date_label=date_label)
