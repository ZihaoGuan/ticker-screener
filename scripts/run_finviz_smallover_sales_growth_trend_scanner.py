...
from src.finviz_smallover_sales_growth_trend_scanner import (
    ...
    FINVIZ_SMALLOVER_SALES_GROWTH_TREND_LABEL,
    MIN_DAILY_RS_RATING,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run live Finviz small-plus sales-growth trend scanner.")
...
def main() -> int:
    ...
    result = run_finviz_smallover_sales_growth_trend_scanner(
        limit=args.limit,
