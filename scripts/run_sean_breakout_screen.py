...
from src.sean_breakout_screen import run_sean_breakout_screen
from src.sean_breakout_watchlist_builder import build_sean_breakout_watchlist
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Sean breakout screen.")
...
def main() -> int:
    ...
    result = run_sean_breakout_screen(config, universe, as_of_date=as_of_date)
    watchlist = build_sean_breakout_watchlist(result.hits)
