...
from src.market_correction_resilience_screen import run_market_correction_resilience_screen
from src.market_correction_resilience_watchlist_builder import build_market_correction_resilience_watchlist
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run market-correction resilience screener.")
...
def main() -> int:
    ...
    result = run_market_correction_resilience_screen(config, tickers, as_of_date=as_of_date)
    watchlist = build_market_correction_resilience_watchlist(result.hits)

    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="market_correction_resilience", date_label=date_label)
    ...
    _write_json(
        summary_path,
        {
            "strategy_id": "market_correction_resilience",
