...
from src.cup_detection_screen import run_cup_detection_screen
from src.cup_detection_watchlist_builder import build_cup_detection_watchlist
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the cup detection screener.")
...
def main() -> int:
    ...
    result = run_cup_detection_screen(config, tickers, as_of_date=as_of_date)
    watchlist = build_cup_detection_watchlist(result.hits)
    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="cup_detection", date_label=date_label)
