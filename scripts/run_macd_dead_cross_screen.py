...
from src.macd_screen import run_macd_screen
from src.macd_watchlist_builder import build_macd_watchlist
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the MACD dead cross screener.")
...
def main() -> int:
    ...
    result = run_macd_screen(config, tickers, direction="dead_cross", as_of_date=as_of_date)
    watchlist = build_macd_watchlist(result.hits)
    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="macd_dead_cross", date_label=date_label)
