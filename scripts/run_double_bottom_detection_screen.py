...
from src.double_bottom_detection_screen import run_double_bottom_detection_screen
from src.double_bottom_detection_watchlist_builder import build_double_bottom_detection_watchlist
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the double bottom detection screener.")
...
def main() -> int:
    ...
    result = run_double_bottom_detection_screen(config, tickers, as_of_date=as_of_date)
    watchlist = build_double_bottom_detection_watchlist(result.hits)
    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="double_bottom_detection", date_label=date_label)
