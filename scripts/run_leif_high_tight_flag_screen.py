...
from src.leif_high_tight_flag_screen import run_leif_high_tight_flag_screen
from src.leif_high_tight_flag_watchlist_builder import build_leif_high_tight_flag_watchlist
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Leif-style High Tight Flag screen.")
...
def main() -> int:
    ...
    result = run_leif_high_tight_flag_screen(config, universe, as_of_date=as_of_date)
    watchlist = build_leif_high_tight_flag_watchlist(result.hits)
    ...
    _write_json(
        summary_path,
        {
            ...
            "signal_profile": "leif_high_tight_flag",
