...
from src.near_52wk_high_watchlist_builder import build_near_52wk_high_watchlist
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run near-52-week-high screener.")
...
def main() -> int:
    ...
    result = run_near_52wk_high_screen(config, tickers, as_of_date=as_of_date)
    watchlist = build_near_52wk_high_watchlist(result.hits)

    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="near_52wk_high", date_label=date_label)
