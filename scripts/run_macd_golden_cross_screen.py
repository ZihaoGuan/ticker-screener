...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the MACD golden cross screener.")
...
def main() -> int:
    ...
    result = run_macd_screen(config, tickers, direction="golden_cross", as_of_date=as_of_date)
    watchlist = build_macd_watchlist(result.hits)
    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="macd_golden_cross", date_label=date_label)
