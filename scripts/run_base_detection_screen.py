...
from src.base_detection_screen import run_base_detection_screen
from src.base_detection_watchlist_builder import build_base_detection_watchlist
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the base detection screener.")
...
def main() -> int:
    ...
    result = run_base_detection_screen(config, tickers, as_of_date=as_of_date)
    watchlist = build_base_detection_watchlist(result.hits)
    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="base_detection", date_label=date_label)
