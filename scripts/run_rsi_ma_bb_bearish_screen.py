...
from src.rsi_ma_bb_screen import run_rsi_ma_bb_screen
from src.rsi_ma_bb_watchlist_builder import build_rsi_ma_bb_watchlist
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the bearish RSI MA/BB signal screen.")
...
def main() -> int:
    ...
    result = run_rsi_ma_bb_screen(config, universe, direction="bearish", as_of_date=as_of_date)
    watchlist = build_rsi_ma_bb_watchlist(result.hits)

    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="rsi_ma_bb_bearish", date_label=date_label)
