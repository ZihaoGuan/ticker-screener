...
from src.sma200_pullback_buy_screen import run_sma200_pullback_buy_screen
from src.sma200_pullback_buy_watchlist_builder import build_sma200_pullback_buy_watchlist
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the 200 SMA pullback buy screen.")
...
def main() -> int:
    ...
    result = run_sma200_pullback_buy_screen(config, universe, as_of_date=as_of_date)
    watchlist = build_sma200_pullback_buy_watchlist(result.hits)

    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="sma200_pullback_buy", date_label=date_label)
    ...
    _write_json(
        summary_path,
        {
            ...
            "signal_profile": "sma200_pullback_buy",
