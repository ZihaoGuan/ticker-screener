...
from src.finviz_analyst_recom_scanner import (
    ...
    FINVIZ_ANALYST_RECOM_STRONGBUY_LABEL,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run live Finviz analyst recommendation strong buy scanner.")
...
def main() -> int:
    ...
    result = run_finviz_analyst_recom_strongbuy_scanner(limit=args.limit, tickers=requested_tickers)
