...
from src.bollinger_band_breakout_watchlist_builder import build_bollinger_band_breakout_watchlist
from src.bollinger_band_screen import run_bollinger_band_breakout_screen
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the above-upper-Bollinger-band screen.")
...
def main() -> int:
    ...
    result = run_bollinger_band_breakout_screen(config, universe, as_of_date=as_of_date)
    watchlist = build_bollinger_band_breakout_watchlist(result.hits)
    ...
    _write_json(
        summary_path,
        {
            ...
            "signal_profile": "bollinger_band_breakout",
