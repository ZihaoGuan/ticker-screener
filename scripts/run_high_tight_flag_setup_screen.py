...
from src.high_tight_flag_setup_screen import run_high_tight_flag_setup_screen
from src.high_tight_flag_setup_watchlist_builder import build_high_tight_flag_setup_watchlist
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the High Tight Flag setup screen.")
...
def main() -> int:
    ...
    result = run_high_tight_flag_setup_screen(config, universe, as_of_date=as_of_date)
    watchlist = build_high_tight_flag_setup_watchlist(result.hits)

    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="high_tight_flag_setup", date_label=date_label)
    ...
    _write_json(
        summary_path,
        {
            ...
            "signal_profile": "high_tight_flag_setup",
