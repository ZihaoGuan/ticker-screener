...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the VCS setup stage screener.")
...
def main() -> int:
    ...
    result = run_vcs_screen(config, tickers, signal_profile="setup_stage", as_of_date=as_of_date)
    watchlist = build_vcs_watchlist(result.hits)
    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="vcs_setup_stage", date_label=date_label)
