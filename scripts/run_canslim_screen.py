...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the CANSLIM score screen.")
...
def main() -> int:
    ...
    result = run_canslim_screen(config, universe, as_of_date=as_of_date, database_url=web_config.database_url)
    watchlist = build_canslim_watchlist(result.hits)

    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="canslim", date_label=date_label)
