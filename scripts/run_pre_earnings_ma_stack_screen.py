...
def main() -> int:
    ...
    artifact_paths = build_screener_artifact_paths(PROJECT_ROOT / "artifacts", strategy_id="pre_earnings_ma_stack", date_label=date_label)
    ...
    _write_json(
        summary_path,
        {
            "strategy_id": "pre_earnings_ma_stack",
