...
class WatchlistServiceTests(unittest.TestCase):
    ...
    def test_guru_strike_zone_promotes_active_ma_support_reclaims(self) -> None:
        strike = _build_guru_strike_zone(
            {
        ...
        self.assertEqual(strike["state"], "active")
        self.assertIn("D EMA21", strike["reason"])
    ...
    def test_get_scanner_board_includes_kai_s2_card(self) -> None:
        self._write_watchlist(
            "kai_s2_2026-06-12",
            tickers=["NVDA", "CRWD"],
            modified_at=dt.datetime(2026, 6, 12, 23, 35, tzinfo=dt.timezone.utc),
        ...
        cards = {item["id"]: item for item in payload["cards"]}
        self.assertTrue(cards["kai_s2"]["available"])
        self.assertEqual(cards["kai_s2"]["entry_count"], 2)
        self.assertEqual(cards["kai_s2"]["preview_tickers"], ["NVDA", "CRWD"])

    def test_get_scanner_board_includes_one_year_winners_card(self) -> None:
        self._write_watchlist(
            "one_year_winners_2026-06-12",
            tickers=["NVDA", "CRWD"],
            modified_at=dt.datetime(2026, 6, 12, 23, 35, tzinfo=dt.timezone.utc),
        )
        ...
        cards = {item["id"]: item for item in payload["cards"]}
        self.assertTrue(cards["one_year_winners"]["available"])
    ...
    def test_get_scanner_board_includes_near_52wk_high_card(self) -> None:
        ...
        cards = {item["id"]: item for item in payload["cards"]}
        self.assertTrue(cards["near_52wk_high"]["available"])
        self.assertEqual(cards["near_52wk_high"]["entry_count"], 2)
        self.assertEqual(cards["near_52wk_high"]["preview_tickers"], ["NVDA", "CRWD"])
    ...
    def test_get_scanner_board_includes_finviz_target_price_card(self) -> None:
        self._write_watchlist(
            "finviz_target_price_50_2026-06-12",
            tickers=["NVDA", "APP"],
            modified_at=dt.datetime(2026, 6, 12, 23, 36, tzinfo=dt.timezone.utc),
        )
        ...
        cards = {item["id"]: item for item in payload["cards"]}
        self.assertTrue(cards["finviz_target_price_50"]["available"])
    ...
    def test_get_scanner_board_includes_finviz_smallover_sales_growth_trend_card(self) -> None:
        self._write_watchlist(
            "finviz_smallover_sales_growth_trend_2026-06-12",
            tickers=["PLTR", "APP"],
            modified_at=dt.datetime(2026, 6, 12, 23, 36, tzinfo=dt.timezone.utc),
        )
        ...
        cards = {item["id"]: item for item in payload["cards"]}
        self.assertTrue(cards["finviz_smallover_sales_growth_trend"]["available"])
        self.assertEqual(cards["finviz_smallover_sales_growth_trend"]["entry_count"], 2)
        self.assertEqual(cards["finviz_smallover_sales_growth_trend"]["preview_tickers"], ["PLTR", "APP"])
    ...
    def test_get_scanner_board_includes_weekly_vcp_cards(self) -> None:
        self._write_watchlist(
            "weekly_vcp_2026-06-12",
            tickers=["NVDA", "CRWD"],
            modified_at=dt.datetime(2026, 6, 12, 23, 36, tzinfo=dt.timezone.utc),
        )
        self._write_watchlist(
            "weekly_vcp_spec_2026-06-12",
            tickers=["APP"],
            modified_at=dt.datetime(2026, 6, 12, 23, 37, tzinfo=dt.timezone.utc),
        )
        ...
        cards = {item["id"]: item for item in payload["cards"]}
        self.assertTrue(cards["weekly_vcp"]["available"])
        self.assertEqual(cards["weekly_vcp"]["entry_count"], 2)
        self.assertEqual(cards["weekly_vcp"]["preview_tickers"], ["NVDA", "CRWD"])
        self.assertTrue(cards["weekly_vcp_spec"]["available"])
        self.assertEqual(cards["weekly_vcp_spec"]["entry_count"], 1)
        self.assertEqual(cards["weekly_vcp_spec"]["preview_tickers"], ["APP"])
    ...
    def test_get_scanner_board_includes_ma_pullback_retest_card(self) -> None:
        self._write_watchlist(
            "ma_pullback_retest_2026-06-12",
            tickers=["NVDA", "AAPL"],
            modified_at=dt.datetime(2026, 6, 12, 23, 31, tzinfo=dt.timezone.utc),
        )
        ...
        cards = {item["id"]: item for item in payload["cards"]}
        self.assertTrue(cards["ma_pullback_retest"]["available"])
        self.assertEqual(cards["ma_pullback_retest"]["entry_count"], 2)
        self.assertEqual(cards["ma_pullback_retest"]["preview_tickers"], ["NVDA", "AAPL"])
