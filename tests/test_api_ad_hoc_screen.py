    ...
    def get_chart_payload(
        ...
        *,
        ...
        return {
            ...
            "rs_markers": [],
            "setup_markers": [],
            "danger_signals": {"as_of_date": "2026-05-30", "active_count": 0, "highest_severity": None, "signals": []},
...
class _FakeMyPicksService:
            ...
            "rows": [
                {
                    ...
                    "perf_year_pct": 40.0,
                    "perf_ytd_pct": 20.0,
                    "change_since_added_pct": 9.2,
                    "ema9_tested_since_added": True,
                    "ema21_tested_since_added": False,
                    ...
                    "trend_template_match": True,
                    "trend_template_criteria_passed": 8,
                    "trend_template_criteria_total": 8,
                    "trend_template_label": "8/8",
    ...
    def create_pick(self, **kwargs: object):
        return {
            ...
            "perf_year_pct": 30.0,
            "perf_ytd_pct": 12.0,
            "change_since_added_pct": 5.8,
            "ema9_tested_since_added": False,
            "ema21_tested_since_added": True,
            "fundamental_rating": 8.1,
            "fundamental_rank": 19,
            "fundamental_status": "ok",
            "leadership_score": 88.0,
            "technical_indicator_ratings": {},
            "trend_template_match": False,
            "trend_template_criteria_passed": 6,
            "trend_template_criteria_total": 8,
            "trend_template_label": "6/8",
