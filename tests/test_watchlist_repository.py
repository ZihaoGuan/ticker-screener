...
class WatchlistRepositoryTests(unittest.TestCase):
    ...
    def test_group_key_supports_gamma_squeeze(self) -> None:
        ...
        self.assertEqual(rows[0]["stem"], "gamma_squeeze_2026-06-06")
        self.assertEqual(rows[0]["group_key"], "gamma_squeeze")
    ...
    def test_group_key_supports_weekly_vcp(self) -> None:
        self._write_new_watchlist(
            date_folder="2026-06-06",
        ...
        self.assertEqual(rows[0]["stem"], "weekly_vcp_2026-06-06")
        self.assertEqual(rows[0]["group_key"], "weekly_vcp")
    ...
    def test_group_key_supports_kai_s2(self) -> None:
        self._write_new_watchlist(
            date_folder="2026-06-06",
            strategy_id="kai_s2",
            date_label="2026-06-06",
    ...
    def test_group_key_supports_qullamaggie(self) -> None:
        self._write_new_watchlist(
            date_folder="2026-06-06",
        ...
        self.assertEqual(rows[0]["stem"], "qullamaggie_2026-06-06")
        self.assertEqual(rows[0]["group_key"], "qullamaggie")
