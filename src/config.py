...
class AppConfig:
    ...
    ftd_sweep_recovery_body_multiplier: float = 1.5
    ftd_sweep_recovery_volume_multiplier: float = 1.1
    ftd_sweep_breakout_volume_multiplier: float = 1.15
    ftd_sweep_confirm_window_days: int = 2
    ftd_sweep_ftd_window_days: int = 5
    ftd_sweep_exhaustion_days: int = 3
    ftd_sweep_post_ftd_days: int = 100
    ftd_sweep_sweep_range_days: int = 26
    ftd_sweep_recent_breakout_lookback_days: int = 3
