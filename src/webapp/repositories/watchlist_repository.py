...
def _group_for_stem(stem: str) -> tuple[str, str]:
    rules = (
        ...
        ("weekly_rs_new_high_all", "weekly_rs_new_high", "Weekly RS New High"),
        ("eight_week_100_runup", "eight_week_100_runup", "8W 100% Runup"),
        ("htf_8w_runup", "eight_week_100_runup", "8W 100% Runup"),
        ("elite_rs_hv1", "elite_rs_hv1", "Elite RS + HV1"),
        ("elite_rs_recent_peg", "elite_rs_recent_peg", "Elite RS + Recent PEG"),
        ("pine_peg", "pine_peg", "Pine PEG"),
        ("monster_gap", "monster_gap", "Monster Gap"),
        ...
        ("bollinger_band_breakout", "bollinger_band_breakout", "Above Upper Bollinger Band"),
        ("ema21_pullback_buy", "ema21_pullback_buy", "EMA21 Pullback Buy"),
        ("ma_pullback_retest", "ma_pullback_retest", "MA Pullback & Retest"),
        ...
        ("weekly_vcp", "weekly_vcp", "Weekly VCP"),
        ("weekly_vcp_scored", "weekly_vcp_scored", "Weekly VCP Scored"),
        ("weekly_vcp_v3", "weekly_vcp_v3", "Weekly VCP v3"),
        ("weekly_vcp_spec", "weekly_vcp_spec", "Weekly VCP Spec"),
        ("weekly_sepa_vcp", "weekly_sepa_vcp", "Weekly SEPA VCP"),
        ("sepa_vcp", "sepa_vcp", "SEPA VCP"),
        ("vcp_v3", "vcp_v3", "VCP v3"),
        ("vcp_spec", "vcp_spec", "VCP Spec"),
        ("rti", "rti", "Range Tightness Index"),
        ("rmv_tightness", "rmv_tightness", "RMV Tight Entry Zones"),
