...
_SCANNER_BOARD_CONFIG: tuple[dict[str, str], ...] = (
    ...
    },
    {
        ...
        "label": "Weekly VCP",
        "description": "Classic VCP candidates reconstructed from weekly OHLCV with contraction count, pivot, support, and weekly volume context.",
        "timeframe": "Weekly",
        "accent": "violet",
        "bias_group": "bullish",
    },
    ...
    },
    {
        ...
        "strategy_id": "weekly_vcp_scored",
        "label": "Weekly VCP Scored",
        "description": "Weekly VCP candidates ranked with weekly trend, contraction, volume, pivot, and RS scoring.",
        "timeframe": "Weekly",
        "accent": "violet",
        "bias_group": "bullish",
    },
    ...
    {
        "id": "weekly_vcp_v3",
        "strategy_id": "weekly_vcp_v3",
        "label": "Weekly VCP v3",
        "description": "Weekly swing-based VCP scanner split between pre-breakout coils and fresh breakouts, with weekly contraction and risk-reward context.",
        "timeframe": "Weekly",
        "accent": "violet",
        "bias_group": "bullish",
    },
    ...
    {
        "id": "weekly_vcp_spec",
        "strategy_id": "weekly_vcp_spec",
        "label": "Weekly VCP Spec",
        "description": "Strict geometric VCP scan on weekly candles with weekly stage-2, prior-uptrend, shrinking-contraction, and pivot rules.",
        "timeframe": "Weekly",
        "accent": "violet",
        "bias_group": "bullish",
    },
    ...
    },
    {
        ...
        "strategy_id": "stockbee_9m_movers",
        "label": "Stockbee 9 Million Movers",
        "description": "Liquid attention list: stocks trading at least 9 million shares on the latest session.",
        "timeframe": "Daily",
        "accent": "amber",
        "bias_group": "bullish",
    },
    {
        ...
        "strategy_id": "stockbee_20pct_weekly_movers",
        "label": "Stockbee 20% Weekly Movers",
        "description": "Momentum list: latest close is at least 20% above the close five sessions earlier.",
        "timeframe": "Daily",
        "accent": "amber",
        "bias_group": "bullish",
    },
    {
        ...
        "strategy_id": "stockbee_4pct_daily_movers",
        "label": "Stockbee 4% Daily Movers",
        "description": "Fresh momentum list: latest close is at least 4% above the prior session close.",
        "timeframe": "Daily",
        "accent": "amber",
        "bias_group": "bullish",
    },
    ...
    {
        "id": "weekly_sepa_vcp",
        "strategy_id": "weekly_sepa_vcp",
        "label": "Weekly SEPA",
        "description": "SEPA names passing the Minervini trend template on weekly candles with weekly risk, pressure, and RS dashboard context.",
        "timeframe": "Weekly",
        "accent": "violet",
        "bias_group": "bullish",
    },
