...
class RunService:
    ...
    _actions = {
        ...
        "build_scanner_top_hits_snapshot": RunAction(
            "build_scanner_top_hits_snapshot",
        ...
        "refresh_split_adjusted_history": RunAction(
            "refresh_split_adjusted_history",
            "Refresh Split-Adjusted Price History",
            "scripts/refresh_split_adjusted_history.py",
            supports_limit=False,
            fields=(
                _as_of_date_field,
                _start_date_field,
        ...
        "refresh_sector_etf_holdings": RunAction(
            "refresh_sector_etf_holdings",
            "Refresh Sector ETF Holdings",
            "scripts/refresh_sector_etf_holdings.py",
            supports_limit=False,
            fields=(
                _tickers_field,
            ),
        ...
        "daily_rs_new_high": RunAction(
            "daily_rs_new_high",
            "Run Daily RS New High",
            "scripts/run_daily_rs_new_high_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "rs_phase": RunAction(
            "rs_phase",
            "Run RS Phase",
            "scripts/run_rs_phase_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "weekly_vcp": RunAction(
            "weekly_vcp",
            "Run Weekly VCP",
            "scripts/run_weekly_vcp_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "vcp_scored": RunAction(
            "vcp_scored",
            "Run VCP Scored",
            "scripts/run_vcp_scored_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "weekly_vcp_scored": RunAction(
            "weekly_vcp_scored",
            "Run Weekly VCP Scored",
            "scripts/run_weekly_vcp_scored_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "weekly_vcp_v3": RunAction(
            "weekly_vcp_v3",
            "Run Weekly VCP v3",
            "scripts/run_weekly_vcp_v3_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "vcp_spec": RunAction(
            "vcp_spec",
            "Run VCP Spec",
            "scripts/run_vcp_spec_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "weekly_vcp_spec": RunAction(
            "weekly_vcp_spec",
            "Run Weekly VCP Spec",
            "scripts/run_weekly_vcp_spec_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "elite_rs_hv1": RunAction(
            "elite_rs_hv1",
            "Run Elite RS + HV1",
            "scripts/run_elite_rs_screen.py",
            extra_args=("--profile", "hv1"),
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "elite_rs_recent_peg": RunAction(
            "elite_rs_recent_peg",
            "Run Elite RS + Recent PEG",
            "scripts/run_elite_rs_screen.py",
            extra_args=("--profile", "recent-peg"),
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "monster_gap": RunAction(
            "monster_gap",
            "Run Monster Gap",
            "scripts/run_earnings_gap_screen.py",
            extra_args=("--profile", "monster-gap"),
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "monster_peg": RunAction(
            "monster_peg",
            "Run Monster Peg",
            "scripts/run_earnings_gap_screen.py",
            extra_args=("--profile", "monster-peg"),
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "inside_dryup_v2": RunAction(
            "inside_dryup_v2",
            "Run Inside Day + Extreme Dry-Up v2",
            "scripts/run_inside_dryup_v2_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "wyckoff_buy_signal": RunAction(
            "wyckoff_buy_signal",
            "Run Wyckoff Buy Signal",
            "scripts/run_wyckoff_buy_signal_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "bollinger_band_breakout": RunAction(
            "bollinger_band_breakout",
            "Run Above Upper Bollinger Band",
            "scripts/run_bollinger_band_breakout_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "ema21_pullback_buy": RunAction(
            "ema21_pullback_buy",
            "Run EMA21 Pullback Buy",
            "scripts/run_ema21_pullback_buy_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "position_action_daily": RunAction(
            ...
            "scripts/run_position_action_daily_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "sma200_pullback_buy": RunAction(
            ...
            "scripts/run_sma200_pullback_buy_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "high_tight_flag_setup": RunAction(
            "high_tight_flag_setup",
            "Run High Tight Flag Setup",
            "scripts/run_high_tight_flag_setup_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "leif_high_tight_flag": RunAction(
            "leif_high_tight_flag",
            "Run Leif High Tight Flag",
            "scripts/run_leif_high_tight_flag_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "weekly_sepa_vcp": RunAction(
            "weekly_sepa_vcp",
            "Run Weekly SEPA VCP",
            "scripts/run_weekly_sepa_vcp_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "rmv_tightness": RunAction(
            "rmv_tightness",
            "Run RMV Tightness",
            "scripts/run_rmv_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "weinstein_stage2_early": RunAction(
            "weinstein_stage2_early",
            "Run Weinstein Stage 2 Early",
            "scripts/run_weinstein_stage2_early_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "eight_week_100_runup": RunAction(
        ...
        "weekly_rs_new_high": RunAction(
            "weekly_rs_new_high",
            "Run Weekly RS New High",
            "scripts/run_weekly_rs_new_high_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "near_52wk_high": RunAction(
            "near_52wk_high",
            "Run Near 52W High",
            "scripts/run_near_52wk_high_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "minervini_vcp_detector": RunAction(
            "minervini_vcp_detector",
            "Run Minervini VCP Detector",
            "scripts/run_minervini_vcp_detector_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "weekly_candidate_pool": RunAction(
            "weekly_candidate_pool",
            "Run Weekly Candidate Pool",
            "scripts/run_weekly_candidate_pool_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "kai_s1": RunAction(
            "kai_s1",
            "Run Kai S1",
            "scripts/run_kai_s1_screen.py",
            fields=(
                _limit_field, _tickers_field, _date_label_field, _as_of_date_field, _market_data_source_field,
                _filter_precedence_field, _include_sectors_field, _exclude_sectors_field, _include_industries_field,
                _exclude_industries_field, _include_themes_field, _exclude_themes_field,
            ),
            bias_group="bullish",
            bullish_subgroup="leaders",
        ),
        ...
        "one_year_winners": RunAction(
            "one_year_winners",
            "Run 1Y Winners > $10B",
            "scripts/run_one_year_winners_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "qullamaggie": RunAction(
            "qullamaggie",
            "Run Qullamaggie",
            "scripts/run_qullamaggie_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "darvas_box_breakout": RunAction(
            "darvas_box_breakout",
            "Run Darvas Box Breakout",
            "scripts/run_darvas_box_breakout_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "market_correction_resilience": RunAction(
            "market_correction_resilience",
            "Run Market Correction Resilience",
            "scripts/run_market_correction_resilience_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "stockbee_momentum_burst": RunAction(
            "stockbee_momentum_burst",
            "Run Stockbee Momentum Burst",
            "scripts/run_stockbee_momentum_burst_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "canslim_v2": RunAction(
            "canslim_v2",
            "Run CANSLIM V2",
            "scripts/run_canslim_v2_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "liquid_growth": RunAction(
            "liquid_growth",
            "Run Liquid Growth (TML)",
            "scripts/run_liquid_growth_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
        ...
        "minervini_growth_acceleration": RunAction(
            "minervini_growth_acceleration",
            "Run Minervini Growth Acceleration",
            "scripts/run_minervini_growth_acceleration_screen.py",
            fields=(
                _limit_field,
                _tickers_field,
                _date_label_field,
