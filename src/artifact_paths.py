...
_STRATEGY_SPECS: dict[str, dict[str, Any]] = {
    ...
    "bollinger_band_breakout": {
        "stem_template": "bollinger_band_breakout_{date_label}",
        "legacy_watchlist_templates": ("bollinger_band_breakout_{date_label}.json",),
        "legacy_raw_templates": ("bollinger_band_breakout_{date_label}.json",),
        "legacy_summary_templates": ("bollinger_band_breakout_run_summary_{date_label}.json",),
    },
    "ema21_pullback_buy": {
    ...
    "stockbee_9m_movers": {
        "stem_template": "stockbee_9m_movers_{date_label}",
        "legacy_watchlist_templates": ("stockbee_9m_movers_{date_label}.json",),
        "legacy_raw_templates": ("stockbee_9m_movers_{date_label}.json",),
        "legacy_summary_templates": ("stockbee_9m_movers_run_summary_{date_label}.json",),
    },
    "stockbee_20pct_weekly_movers": {
        "stem_template": "stockbee_20pct_weekly_movers_{date_label}",
        "legacy_watchlist_templates": ("stockbee_20pct_weekly_movers_{date_label}.json",),
        "legacy_raw_templates": ("stockbee_20pct_weekly_movers_{date_label}.json",),
        "legacy_summary_templates": ("stockbee_20pct_weekly_movers_run_summary_{date_label}.json",),
    },
    "stockbee_4pct_daily_movers": {
        "stem_template": "stockbee_4pct_daily_movers_{date_label}",
        "legacy_watchlist_templates": ("stockbee_4pct_daily_movers_{date_label}.json",),
        "legacy_raw_templates": ("stockbee_4pct_daily_movers_{date_label}.json",),
        "legacy_summary_templates": ("stockbee_4pct_daily_movers_run_summary_{date_label}.json",),
    },
    "vcp_spec": {
    ...
    "finviz_target_price_50": {
        "stem_template": "finviz_target_price_50_{date_label}",
        "legacy_watchlist_templates": ("finviz_target_price_50_{date_label}.json",),
    ...
    "finviz_smallover_sales_growth_trend": {
        "stem_template": "finviz_smallover_sales_growth_trend_{date_label}",
        "legacy_watchlist_templates": ("finviz_smallover_sales_growth_trend_{date_label}.json",),
        "legacy_raw_templates": ("finviz_smallover_sales_growth_trend_{date_label}.json",),
        "legacy_summary_templates": ("finviz_smallover_sales_growth_trend_run_summary_{date_label}.json",),
    },
...
_LEGACY_PREFIX_TO_STRATEGY: tuple[tuple[str, str], ...] = (
    ...
    ("stockbee_20pct_weekly_movers", "stockbee_20pct_weekly_movers"),
    ("stockbee_4pct_daily_movers", "stockbee_4pct_daily_movers"),
    ...
    ("finviz_smallover_sales_growth_trend", "finviz_smallover_sales_growth_trend"),
